...
/// @brief Class for a tool that creates an angle bisector
class AngleBisectorTool : public Tool {
public:
    AngleBisectorTool(wxWindow *parent, DrawingCanvas *drawingCanvas, wxWindowID id = wxID_ANY, const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxDefaultSize);
...
private:
    ...
    GeoObject* firstObj = nullptr;
    /// Second selected object 
    GeoObject* secondObj = nullptr;
    /// Temporary angle bisector
