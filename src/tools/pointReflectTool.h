...
/// @brief Class for a tool that reflects along a point
class PointReflectTool : public Tool {
public:
    PointReflectTool(wxWindow *parent, DrawingCanvas *drawingCanvas, wxWindowID id = wxID_ANY, const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxDefaultSize);
